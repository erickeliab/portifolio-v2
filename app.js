...
app.use('/messages/unread',express.static(path.join(__dirname, 'public')));
...
app.use('/projectz',express.static(path.join(__dirname, 'public')));
app.use('/services',express.static(path.join(__dirname, 'public')));
app.use('/cv/edit',express.static(path.join(__dirname, 'public')));
